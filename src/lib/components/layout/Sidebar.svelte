<script lang="ts">
	...
	const navigation = [
		...
		},
		{
			name: 'Worklist',
			href: '/worklist',
			icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-7 9l2 2 4-4" />`
		},
		{
			name: 'Meetings',
			href: '/meetings',
